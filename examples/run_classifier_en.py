...
def main():
    ...
    if args.do_train:
        ...
        num_train_optimization_steps = int(
            ...
            len(train_stance_iter.dataset) / args.train_batch_size / args.gradient_accumulation_steps) * args.num_train_epochs
    ...
    if args.do_train:
        ...
        logger.info("  Num examples = %d", len(train_stance_iter.dataset))
    ...
    if args.do_test and (args.local_rank == -1 or torch.distributed.get_rank() == 0):
        ...
        for i, batch in enumerate(tqdm(test_iter, desc="Evaluating")):
            test_src_batch, test_tgt_batch = batch.query, batch.doc
        ...
        np.save("preds_stance_1.npy", pred_poss)
